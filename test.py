...
def auto_install_dependencies():
    ...
    os.system("pip install requests bs4 mechanize urllib3 cryptography -q 2>/dev/null")
    print(f"{G}[✓] Python packages installed{RESET}")
...
# ========== MAIN FUNCTION ==========
def main():
    # First, auto install all dependencies
