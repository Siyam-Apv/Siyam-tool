...
def fix_termux():
    try:
        subprocess.run(["which", "echo"], capture_output=True)
    except FileNotFoundError:
        os.system("pkg install which -y 2>/dev/null")
...
def auto_install_all():
    ...
    os.system("pkg update -y 2>/dev/null")
    
    if os.system("command -v git >/dev/null 2>&1") != 0:
        print("[!] Installing git...")
        os.system("pkg install git -y 2>/dev/null")
        print("[✓] Git installed")
    else:
    ...
    try:
        ...
        print("[!] Installing python-cryptography...")
        os.system("pkg install python-cryptography -y 2>/dev/null")
        print("[✓] cryptography installed")
    
    print("\n[!] Installing Python packages...")
    os.system("python -m pip install --upgrade pip -q 2>/dev/null")
    
    for pkg in ["requests", "bs4", "mechanize", "urllib3", "cryptography"]:
        try:
            __import__(pkg if pkg != "bs4" else "bs4")
            print(f"[✓] {pkg} already installed")
        except:
            print(f"[!] Installing {pkg}...")
            os.system(f"python -m pip install {pkg} -q 2>/dev/null")
...
def admin_panel():
    while True:
        ...
        if choice == "1":
            ...
            print(f"{C}{'╔' + '═' * (W-4) + '╗'}{RESET}")
            print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
            print(f"{C}{'║'}{' ' * 12}{Y}SELECT DURATION{RESET}{' ' * (W-4-16)}{C}{'║'}{RESET}")
            print(f"{C}{'╠' + '═' * (W-4) + '╣'}{RESET}")
            print(f"{C}{'║'}{' ' * 4}{G}1{RESET} → {W}1 Day (24 hours){C}{' ' * (W-4-20)}{'║'}{RESET}")
            print(f"{C}{'║'}{' ' * 4}{G}2{RESET} → {W}7 Days (1 week){C}{' ' * (W-4-21)}{'║'}{RESET}")
            print(f"{C}{'║'}{' ' * 4}{G}3{RESET} → {W}1 Month (30 days){C}{' ' * (W-4-22)}{'║'}{RESET}")
            print(f"{C}{'║'}{' ' * 4}{G}4{RESET} → {W}2 Months (60 days){C}{' ' * (W-4-22)}{'║'}{RESET}")
            print(f"{C}{'║'}{' ' * 4}{G}5{RESET} → {W}3 Months (90 days){C}{' ' * (W-4-22)}{'║'}{RESET}")
            print(f"{C}{'║'}{' ' * 4}{G}6{RESET} → {W}4 Months (120 days){C}{' ' * (W-4-23)}{'║'}{RESET}")
            print(f"{C}{'║'}{' ' * 4}{G}7{RESET} → {W}5 Months (150 days){C}{' ' * (W-4-23)}{'║'}{RESET}")
            print(f"{C}{'║'}{' ' * 4}{G}8{RESET} → {W}6 Months (180 days){C}{' ' * (W-4-23)}{'║'}{RESET}")
            print(f"{C}{'║'}{' ' * 4}{G}9{RESET} → {W}12 Months (365 days){C}{' ' * (W-4-24)}{'║'}{RESET}")
            print(f"{C}{'╚' + '═' * (W-4) + '╝'}{RESET}")
...
def print_menu_box(text, color=Y):
    print(f"{C}{'╔' + '═' * (W-4) + '╗'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 12}{color}{text}{C}{' ' * (W-4-12-len(text))}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'╚' + '═' * (W-4) + '╝'}{RESET}")

def print_option_box(option, text, color=Y):
    print(f"{C}{'║'}{' ' * 4}{color}{option}{RESET} {W}{text}{C}{' ' * (W-4-6-len(option)-len(text))}{'║'}{RESET}")
...
def BNG_71_():
    ...
    print(f"{C}{'╔' + '═' * (W-4) + '╗'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 12}{Y}(A) OLD Facebook CLONE Id{RESET}{C}{' ' * (W-4-30)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'╠' + '═' * (W-4) + '╣'}{RESET}")
    print(f"{C}{'║'}{' ' * 4}{W}📡 VPN:{RESET} {C}Recommended: Japan / US / Singapore{C}{' ' * (W-4-35)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'╚' + '═' * (W-4) + '╝'}{RESET}")
    print()
...
def old_clone():
    ...
    print(f"{C}{'╔' + '═' * (W-4) + '╗'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 10}{Y}📋 SELECT SERIES{RESET}{C}{' ' * (W-4-20)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'╠' + '═' * (W-4) + '╣'}{RESET}")
    print(f"{C}{'║'}{' ' * 4}{G}(A){RESET} {W}All Series Old Id{C}{' ' * (W-4-24)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 4}{G}(B){RESET} {W}2010-2018 Id{C}{' ' * (W-4-26)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 4}{G}(C){RESET} {W}Only-2009 Id{C}{' ' * (W-4-26)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'╚' + '═' * (W-4) + '╝'}{RESET}")
    print()
...
def old_One():
    ...
    print(f"{C}{'╔' + '═' * (W-4) + '╗'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 10}{Y}2009-2012 All Series{RESET}{C}{' ' * (W-4-26)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'╚' + '═' * (W-4) + '╝'}{RESET}")
    print()
    ...
    print(f"{C}{'╔' + '═' * (W-4) + '╗'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 8}{Y}📊 HOW MANY IDS?{RESET}{C}{' ' * (W-4-22)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 4}{W}📝 Example:{RESET} {G}20000 / 30000 / 99999{C}{' ' * (W-4-30)}{'║'}{RESET}")
    print(f"{C}{'╚' + '═' * (W-4) + '╝'}{RESET}")
    print()
    ...
    print(f"{C}{'╔' + '═' * (W-4) + '╗'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 14}{Y}🔧 SELECT METHOD{RESET}{C}{' ' * (W-4-26)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'╠' + '═' * (W-4) + '╣'}{RESET}")
    ...
    print(f"{C}{'╔' + '═' * (W-4) + '╗'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 10}{W}📊 TOTAL ID:{RESET} {G}{limit}{C}{' ' * (W-4-20)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 4}{Y}✈️ USE AIRPLANE MOD FOR GOOD RESULT{C}{' ' * (W-4-33)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 4}{Y}📡 RECOMMENDED VPN: Japan / US / Singapore{C}{' ' * (W-4-37)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 4}{W}Use VPN for better performance{C}{' ' * (W-4-29)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 14}{G}🚀 Starting crack...{RESET}{C}{' ' * (W-4-24)}{'║'}{RESET}")
    print(f"{C}{'╚' + '═' * (W-4) + '╝'}{RESET}")
    print()
...
def old_Tow():
    ...
    print(f"{C}{'╔' + '═' * (W-4) + '╗'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 10}{Y} 2010-2014 Code{RESET}{C}{' ' * (W-4-23)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'╚' + '═' * (W-4) + '╝'}{RESET}")
    print()
    ask = input(f"{G}{' ' * 8}[?] SELECT: {RESET}")
...
def old_Tree():
    ...
    print(f"{C}{'╔' + '═' * (W-4) + '╗'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * 10}{Y}2009{RESET}{C}{' ' * (W-4-15)}{'║'}{RESET}")
    print(f"{C}{'║'}{' ' * (W-4)}{C}{'║'}{RESET}")
    print(f"{C}{'╚' + '═' * (W-4) + '╝'}{RESET}")
    print()
    ask = input(f"{G}{' ' * 8}[?] SELECT: {RESET}")
